...
```{r}
BigEBoys <- filter(MediaSalary, COMPANY %in% c("NewYorkTimes", "WallStreetJournal", "Bloomberg"))    
```
...
paid <- subset(MediaBucks, Salary=="230504")  

#A senior reporter at ProPublic is making $230,504.

#2. Make a table for editors, figure out medians. 
Editors <- subset(MediaBucks, grepl("?editor", TITLE))
summary(Editors$Salary)

#The median salary for editors is $60240.00.

#3.Find highest paid editor. Resent them.  

MediaBucks %>% 
  select(COMPANY, TITLE, Salary) %>% slice_max(Salary, n = 10)

#The highest paid editor is a senior photo editor from tribune publishing who makes $770,000.
...
#The highest paid position at NYT is an executive editor who is Black and put noanswer for gender. 
...
#The median salary at Bloomberg is lower than the median salary at the New York Times. 
