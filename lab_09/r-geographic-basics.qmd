...
**Two questions we can answer with a spatial join include:**

Do Prince George's County neighborhoods in lower-income areas have a higher concentration of people of color? The two geographic dataframes needed would include the location of neighborhoods in Prince George's County and their income data, as well as racial datasets of those neighborhoods. We could use this to create a map of Prince George's County with the concentration of people of color.

Another question could be: Do Prince George's County neighborhoods in lower-income areas have higher or lower crime rates? The two geographic dataframes needed would include the location of neighborhoods in Prince George's County and their crime data. We could use this to create a map of Prince George's County with crime rates.
