...
Two geographic dataframes that I would need to answer my questions would be the PG County dataframe, the median household income of different areas in Prince George's County and the distribution of white people within the county?

I would ask the questions:

1\) Are there any significant findings about if the distribution of white people are located in high or low median income areas of Prince George's County?

2\) Are there any increases or decreases overtime in median income to areas of Prince George's County that have a population of over 50% people of color?
