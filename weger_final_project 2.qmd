...
baltimore_port_jobs <- read_csv("~/Downloads/baltimore_port_jobs.csv") %>%
clean_names() 
...
maryland_jobs <- read_csv("~/Downloads/maryland_jobs.csv") %>%
...
bmore_commodities <- read_csv("~/Downloads/bmore_commodities.csv") %>%
...
```{r}
#import county data 
port_counties <- read_csv("~/Downloads/port_counties.csv") %>%
clean_names() 

#delete the total row and county row
port_counties <- port_counties[-c(9, 15), ]
